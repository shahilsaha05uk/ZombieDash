...
namespace AdvancedSceneManager.Core
{
    ...
    public class Callback
    {
        ...
        public static Callback AfterLoadingScreenOpen() =>
            new Callback() { when = When.Before }; //This means 'before' operation has started, after loading screen open

        /// <summary>Runs a callback before loading screen closes.</summary>
        public static Callback BeforeLoadingScreenClose() =>
            new Callback() { when = When.After }; //This means 'after' operation has completed, before loading screen close
        ...
        public static Callback After(Phase phase, Scene on) =>
            new Callback() { when = When.After, phase = phase, scene = on };
