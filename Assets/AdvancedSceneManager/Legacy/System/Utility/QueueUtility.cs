...
namespace AdvancedSceneManager.Utility
{
    ...
    public static class QueueUtility<T> where T : IQueueable
    {
        ...
        /// <param name="duplicateCheck">If <see langword="true"/> is returned item will not be queued. Only has an effect if item is actually was about to be queued.</param>
