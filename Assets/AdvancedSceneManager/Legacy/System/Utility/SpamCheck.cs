...
namespace AdvancedSceneManager.Utility
{
    ...
    public class SpamCheck
    {
        ...
        {
            get => isEventMethods ? SceneManager.settings.profile.preventSpammingEventMethods : m_isEnabled;
        ...
        {
            get => isEventMethods ? Mathf.Abs(Profile.current.spamCheckCooldown) : cooldown;
